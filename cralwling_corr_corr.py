...
if __name__ == "__main__":
    ...
    # 결과 확인
    print(link_df.head())
    print(content_df['content_col'].head())

    
    link_df.to_csv("link_df3.csv", index=False, encoding="utf-8-sig")
    content_df.to_csv("content_df3.csv", index=False, encoding="utf-8-sig")
    ...
    # 첫 번째 기사에서 두 번째 문단
    if len(first_article_content) > 1:
        print(first_article_content[1])
